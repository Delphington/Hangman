...
public class Config {
    ...
    public static final int SECOND_CASE = 1;
    public static final int THIRD_CASE = 2;
    public static final int FOURTH_CASE = 3;
    public static final int FIFTH_CASE = 4;
    public static final int SIXTH_CASE = 5;
